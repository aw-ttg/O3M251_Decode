/*needspatch@xmldoc*/ /* This file provides the definition of the struct Meas_Customer_Data_Type in the interface version DIK1_1.8.
   
   It also provides endianess-aware functions to safely convert a binary buffer to an 
   instance of this struct (if possible).
*/

#ifndef IFM_O3M_MEAS_CUSTOMER_DATA_TYPE_DIK1_1_8_CONVERTER_H_INCLUDED
#define IFM_O3M_MEAS_CUSTOMER_DATA_TYPE_DIK1_1_8_CONVERTER_H_INCLUDED
...
typedef struct
{
    ...
    struct
    {
        ...
        /*@xmldoc(KpCustomerParameter.ROI_Type)*/
        ifm_o3m_uint8_t ROI_Type[64];
        /*@xmldoc(KpCustomerParameter.CAN2DCalibOnOff)*/
        ifm_o3m_uint8_t CAN2DCalibOnOff;
        /*@xmldoc(KpCustomerParameter.CANSafetyMsgEnable)*/
        ifm_o3m_uint8_t CANSafetyMsgEnable;
        /*@xmldoc(KpCustomerParameter.reserved)*/
        ifm_o3m_uint8_t reserved[2];
        ifm_o3m_uint8_t pad_004; /* explicit padding, do not access this member */
        ifm_o3m_uint8_t pad_005; /* explicit padding, do not access this member */
    } KpCustomerParameter;
    struct
...
} ifm_o3m_Meas_Customer_Data_Type_DIK1_1_8;
